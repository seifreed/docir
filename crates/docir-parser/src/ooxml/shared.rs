...
use docir_core::ir::{
    CustomXmlPart, DigitalSignature, DrawingPart, ExtensionPart, ExtensionPartKind, MediaType,
    PeoplePart, PersonEntry, RelationshipEntry, RelationshipGraph, RelationshipTargetMode, Shape,
    ShapeType, Theme, ThemeColor, ThemeFontScheme, VmlDrawing, VmlShape, WebExtension,
    WebExtensionProperty, WebExtensionTaskpane,
};
