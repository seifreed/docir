...
pub(super) fn parse_sheet_comments(
    ...
    parse_sheet_comments_impl(xml, path, sheet_name, CommentFlavor::Legacy)
}
...
pub(super) fn parse_threaded_comments(
    ...
    parse_sheet_comments_impl(xml, path, sheet_name, CommentFlavor::Threaded)
}
