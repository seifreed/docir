...
use docir_core::ir::{
    ...
    LineNumberRestart, LineSpacingRule, NumberingInfo, NumberingLevel, NumberingSet, PageBorders,
    PageMargins, PageOrientation, Paragraph, ParagraphProperties, Revision, RevisionType, Run,
    RunProperties, Section, SectionProperties, SectionType, Style, StyleParagraphProperties,
    StyleRunProperties, StyleSet, StyleType, TextAlignment, UnderlineStyle, VerticalTextAlignment,
...
use table::{parse_table, parse_table_properties};
