...
pub(super) struct GroupState {
    ...
    pub(super) unicode_high_surrogate: Option<u16>,
}
...
pub(crate) struct RtfParseContext {
    ...
    pub(crate) external_refs: Vec<NodeId>,
    pub(crate) ole_objects: Vec<NodeId>,
...
impl RtfParseContext {
    ...
    pub(super) fn push_group(&mut self, kind: GroupKind) -> Result<(), ParseError> {
        ...
        self.group_stack.push(GroupState {
            ...
            unicode_high_surrogate: self.unicode_high_surrogate,
        });
        Ok(())
    }
    ...
    pub(super) fn pop_group(&mut self) -> Result<(), ParseError> {
        ...
        self.unicode_high_surrogate = group.unicode_high_surrogate;
        Ok(())
    }
}
