...
fn parse_ods_table_skips_huge_repeated_empty_rows() {
  ...
  xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0">
  <table:table>
    <table:table-row table:number-rows-repeated="4294967295"></table:table-row>
  </table:table>
</office:spreadsheet>"#;
    let (mut reader, table_start) = parse_table_start(xml);
    let mut config = ParserConfig::default();
    ...
    .expect("empty repeated rows should not require expansion");
...
#[test]
fn parse_ods_table_fast_reports_malformed_sample_column_repeats() {
    let xml: &[u8] = br#"<?xml version="1.0" encoding="UTF-8"?>
<office:spreadsheet xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0"
  xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0">
  <table:table table:name="FastBadRepeat">
    <table:table-row>
      <table:table-cell/>
...
"#;
    ...
    .expect_err("malformed sample repeat must fail");
...
#[test]
fn parse_ods_table_fast_reports_malformed_row_repeats() {
    let xml: &[u8] = br#"<?xml version="1.0" encoding="UTF-8"?>
<office:spreadsheet xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0"
  xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0">
  <table:table table:name="FastBadRows">
    <table:table-row table:number-rows-repeated="bad"/>
  </table:table>
</office:spreadsheet>
"#;
    let (mut reader, table_start) = parse_table_start(xml);
    ...
    .expect_err("malformed row repeat must fail");
...
#[test]
fn parse_ods_table_reports_malformed_boolean_cell_value() {
    let xml: &[u8] = br#"<?xml version="1.0" encoding="UTF-8"?>
<office:spreadsheet xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0"
  xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0">
  <table:table table:name="BadBoolean">
    <table:table-row>
      <table:table-cell table:cell-value-type="boolean" table:cell-value="maybe"/>
    </table:table-row>
  </table:table>
</office:spreadsheet>
"#;
    ...
    .expect_err("malformed boolean value must fail");
...
#[test]
fn parse_ods_cell_empty_reports_malformed_boolean_value() {
    let mut cell = BytesStart::new("table:table-cell");
    cell.push_attribute(("table:cell-value-type", "boolean"));
    cell.push_attribute(("table:cell-value", "maybe"));
    let mut style_map = HashMap::new();
    let mut next_style_id = 1;

    let err = parse_ods_cell_empty(&cell, &mut style_map, &mut next_style_id)
        .expect_err("malformed boolean value must fail");
